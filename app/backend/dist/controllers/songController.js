...
exports.getSongById = exports.loadInitialSong = exports.songsData = void 0;
exports.songsData = [
    {
        id: 1,
...
const loadInitialSong = (req, res) => {
    try {
        if (!exports.songsData) {
            throw new Error("No song data is available");
        }
        res.json(exports.songsData);
    }
    catch (error) {
...
exports.loadInitialSong = loadInitialSong;
const getSongById = (req, res) => {
    try {
        const songId = parseInt(req.params.id);
        const song = exports.songsData.find((s) => s.id === songId);
        if (!song) {
...
module.exports = {
    loadInitialSong: exports.loadInitialSong,
